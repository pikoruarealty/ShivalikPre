...
export default function HomePage() {
  return <><SiteHeader /><main id="main-content" tabIndex={-1}><JsonLd data={websiteSchema()} /><Hero /><Reveal variant="text"><ProjectIntroduction /></Reveal><Reveal variant="list"><ProjectNumbers /></Reveal><Reveal variant="list"><PrivacySection /></Reveal><Reveal variant="image"><RiverfrontSection /></Reveal><Reveal variant="list"><TowersSection /></Reveal><Reveal variant="image"><VistaDeckSection /></Reveal><Reveal variant="text"><ResidencesIntro /></Reveal><Reveal variant="image"><FourBhkSection /></Reveal><Reveal variant="image"><PenthouseSection /></Reveal><Reveal variant="line"><VolumeSection /></Reveal><Reveal variant="list"><InteriorLifeSection /></Reveal><Reveal variant="text"><AmenitiesIntro /></Reveal><Reveal variant="image"><WellnessSection /></Reveal><Reveal variant="list"><LeisureSection /></Reveal><Reveal variant="list"><SocialSection /></Reveal><Reveal variant="list"><OpenSpacesSection /></Reveal><Reveal variant="image"><AmenitiesGallery /></Reveal><Reveal variant="image"><GiftCitySection /></Reveal><Reveal variant="list"><ConnectivitySection /></Reveal><Reveal variant="list"><LocationAdvantageSection /></Reveal><Reveal variant="text"><InvestmentSection /></Reveal><Reveal variant="list"><SeoDiscoverySection /></Reveal><Reveal variant="list"><ProjectFaqSection /></Reveal><Reveal variant="list"><BlogPreview /></Reveal><Reveal variant="line"><LocationMapSection /></Reveal><Reveal variant="text"><LocationCtaSection /></Reveal></main></>;
}
