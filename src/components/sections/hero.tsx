...
export function Hero() {
  ...
  return (
    <section ref={heroRef} className="hero" aria-labelledby="hero-title">
      <ImageFrame src="/images/presente/interiors/riverfront-balcony.jpeg" className="hero-visual" aria-label="4 BHK riverfront balcony at Shivalik Presente GIFT City" priority sizes="100vw" />
