  ...
  return (
    <section id="introduction" className="story-section presence-section" aria-labelledby="presence-title">
      <Container className="presence-grid">
        ...
        <div className="presence-copy"><SectionLabel>Beyond the Residence</SectionLabel><h2 id="presence-title" className="section-heading">Luxury homes in GIFT City,<br /><em>shaped around privacy.</em></h2><p>{project.editorial.introduction}</p><p className="secondary-copy">Shivalik Presente is a collection of premium 4 BHK residences and limited 6 BHK duplex penthouses created for those who value space, discretion and architectural clarity.</p></div>
      </Container>
    </section>
  );
}
